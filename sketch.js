...
function draw() {
 ...
 if(gameState === START){
    ...
    text("WELCOME",170,50);
    textSize(20);
    text("This game is called Keep Away Corona.",25,80);
    text("To win, avoid the virus to not lose a life.",25,120);
    text("Also, collect the gloves, masks, sanitizers",25,160);
    text("vaccines & wash your hands!",25,200);   
    text("Get a score higher than 15 to win!",25,240);
    text("You have 3 lives, if all lives are lost - You lose.",25,280);
    text("Use the space bar to jump",25,320)
    text("Press enter to begin playing! Good Luck!",25,360);
...
function createCovid() {
  ...
  // spawning covid images/sprites
    ...
    var covid = createSprite(600,280);
    covid.y = Math.round(random(280,300));
    covid.scale = 0.05;
  ...
  function createGloves() {
    ...
    var gloves = createSprite(600,100);
    gloves.y = Math.round(random(100,300));
  ...
  function createSanitizer() {
    ...
    var sanitizer = createSprite(600,100);
    sanitizer.y = Math.round(random(100,300));
  ...
  function createVaccine() {
    ...
    var vaccine = createSprite(600,100);
  ...
  function createWashHands() {
    ...
    var washHands = createSprite(600,100);
    washHands.y = Math.round(random(100,300));
